            ...
            if (x_Top >= 0 && x_Bottom >= 0 && x_Top < len && x_Bottom < len) {
                ...
                if ((int) x_Top == (int) x_Bottom) {
                    ...
                    if (x_Top > x_Bottom) {
                        ...
                        float t;
                        _y0 = y_Bottom - (_y0 - y_Top);
                        _y1 = y_Bottom - (_y1 - y_Top);
                        t = _y0, _y0 = _y1, _y1 = t;
                    ...
                    scanline[x2] += area + sign * (1-((x2-x2)+(x_Bottom-x2))/2) * (_y1-y_crossing);
                    
                    scanline_fill[x2] += sign * (_y1-_y0);
                }
            } else {
